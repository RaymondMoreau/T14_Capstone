  ...
  return (
    <div>
      <section className="first-boxes">
        <div className="box">
          <a
            href="https://raymondmoreau.github.io/testWebGL/"
            className="game-link"
          >
        ...
        <div className="box">
          <a
            href="https://tahahoussari.github.io/Walk-The-Plank/"
            className="game-link"
          >
        ...
        <div className="box">
          <a
            href="https://ashton-hagar.github.io/FamiliarFight/"
            className="game-link"
          >
        ...
        <div className="box">
          <a
            href="https://tahahoussari.github.io/back-to-the-future/"
            className="game-link"
          >
      ...
      <section>
        <div className="box">
          <a
            href="https://harisvohra11.github.io/TheBirdofMathMountain/"
            className="game-link"
          >
        ...
        <div className="box">
          <a
            href="https://harisvohra11.github.io/MathIslandRun/"
            className="game-link"
          >
