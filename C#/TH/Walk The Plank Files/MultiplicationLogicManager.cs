...
public class MultiplicationLogicScript : MonoBehaviour //script for the multiplication functionalities of the Walk the Plank game
{
    public MultiplicationCharacterActions character;
    void Start() //function that runs at the start of the scene/game
    {
        randomizeQuestionMultiplication(); //1st question gets randomized at the start
        answerOptionsMultiplication(); //1st answer options gets randomized at the start
    }
    ...
    public void randomizeQuestionMultiplication() //function that randomizes the multiplication questions
    {
        number1 = Random.Range(2, 13);
        number2 = Random.Range(2, 13);
        questionText.text = number1.ToString() + " x " + number2.ToString();
        answerOptionsMultiplication();
    }
    ...
    public void answerOptionsMultiplication() // function that randomizes answer options based on numbers randomly generated previously
    {
